...
const DEFAULT_PREFIX = `You are Doro, Jesse's personal AI coding agent.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Doro, Jesse's personal AI coding agent, running within the Agent SDK.`
const AGENT_SDK_PREFIX = `You are Doro, Jesse's personal AI coding agent.`
